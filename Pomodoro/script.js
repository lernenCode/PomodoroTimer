...
var bell = new Audio("./audio/start.wav") // começar
var volta = new Audio("./audio/return.wav")
var final = new Audio("./audio/finish.wav")
...
function momentoAcao() {
   ...
   // Muda a cor do texto para verde (#3aba0b)
   title.style.setProperty('color', '#3aba0b', 'important')
...
function momentoPausa() {
   ...
   // Muda a grossura do texto para bold
   title.style.fontWeight = 'bold'
   // Muda a cor do texto para amarela (#bab213)
   title.style.setProperty('color', '#bab213', 'important')
